...
- **Data type extraction** (Concept 10): Implement `_extract_column_data_type()` from lazy schema metadata when
  it is available without materializing data; see [Data Type Extraction](10-data-type-extraction.md)
