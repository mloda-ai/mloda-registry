...
def seal_ndjson_runs(
    ...
    *,
    ...
    (AuditExtender refuses a re-run of a session it already sealed: see its class docstring). Pass `run_id`
    when other runs may still be live; omit it to sweep an audit
