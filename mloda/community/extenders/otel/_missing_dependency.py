"""Builds a module-level __getattr__ raised when opentelemetry-api is not installed."""
...
def blames_root(exc: ImportError, root: str) -> bool:
    ...
    Keep in sync with the byte-identical copy in mloda/community/extenders/openlineage/_missing_dependency.py.
    """
