...
@pytest.fixture
def sample_data(conn: sqlite3.Connection) -> SqliteRelation:
    """Return the shared 12-row test dataset as a SqliteRelation."""
...
class TestSqliteBasicAggregations:
...
class TestSqliteNullHandling:
    """Test null handling edge cases for SQLite implementation."""
...
class TestSqliteRowPreservation:
