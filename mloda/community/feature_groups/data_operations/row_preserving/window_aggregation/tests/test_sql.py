"""Tests for SqlWindowAggregation compute implementation."""
...
class TestSqlBasicAggregations:
    """Test sum, avg, count, min, max via SQL window functions."""
    ...
    def test_sum_groupby_region(self, sample_data: pa.Table) -> None:
        ...
        result = SqlWindowAggregation.calculate_feature(sample_data, feature_set)
...
class TestSqlNullHandling:
    """Test null handling edge cases for SQL implementation."""
